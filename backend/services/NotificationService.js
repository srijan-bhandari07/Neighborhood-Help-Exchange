...
class NotificationService {
  constructor(io) {
    ...
    this.messageObserver = new MessageNotificationObserver(this.notificationRepository);
    this.helpPostObserver = new HelpPostNotificationObserver(this.notificationRepository);
    this.systemObserver = new SystemNotificationObserver(this.notificationRepository);
